 ...
 */
class Scanner(
    private val source: Source, k: Int,
...
// ...
     ...
     */
    private fun error(message: String): ScannerException = error(source.charPosition, message)

    /**
     * Returns a ScannerException with the specified error message
     * and token position.
     */
    private fun error(position: Position, message: String) = ScannerException(position, message)
